...
import ru.gorbach.hw12.country.domain.*;
import ru.gorbach.hw12.storage.initor.exception.checked.InitDataCheckedException;
...
import static ru.gorbach.hw12.storage.initor.exception.InitDataExceptionMeta.PARSE_COUNTRY_DISCRIMINATOR_ERROR;
...
public class XmlDataReader implements DataReader {
    ...
    private void appendHotCountryAttributes(CountryWithHotClimate country, Element xmlCountry) {
        String a = xmlCountry.getElementsByTagName("hotMonth").item(0).getTextContent();
