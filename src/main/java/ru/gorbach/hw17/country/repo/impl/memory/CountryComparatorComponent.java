package ru.gorbach.hw17.country.repo.impl.memory;

import ru.gorbach.hw17.country.domain.Country;
import ru.gorbach.hw17.country.search.CountryOrderByField;

import java.util.*;

import static ru.gorbach.hw17.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static ru.gorbach.hw17.country.search.CountryOrderByField.LANGUAGE;
import static ru.gorbach.hw17.country.search.CountryOrderByField.NAME;
