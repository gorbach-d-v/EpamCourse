...
import ru.gorbach.hw17.storage.initor.exception.checked.ParseXmlException;

import java.util.ArrayList;
import java.util.List;

import static ru.gorbach.hw17.storage.initor.exception.InitDataExceptionMeta.PARSE_XML_EXCEPTION;
