...
import ru.gorbach.hw17.customer.search.CustomerOrderByField;

import java.util.*;

import static ru.gorbach.hw17.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static ru.gorbach.hw17.customer.search.CustomerOrderByField.FIRSTNAME;
import static ru.gorbach.hw17.customer.search.CustomerOrderByField.LASTNAME;
