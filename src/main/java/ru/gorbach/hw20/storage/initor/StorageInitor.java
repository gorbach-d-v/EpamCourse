...
import ru.gorbach.hw20.storage.initor.exception.checked.ParseXmlException;

import java.util.ArrayList;
import java.util.List;

import static ru.gorbach.hw20.storage.initor.exception.InitDataExceptionMeta.PARSE_XML_EXCEPTION;
