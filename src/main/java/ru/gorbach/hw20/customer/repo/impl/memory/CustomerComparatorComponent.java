...
import ru.gorbach.hw20.customer.search.CustomerOrderByField;
import ru.gorbach.hw20.customer.domain.Customer;

import java.util.*;

import static ru.gorbach.hw20.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static ru.gorbach.hw20.customer.search.CustomerOrderByField.FIRSTNAME;
import static ru.gorbach.hw20.customer.search.CustomerOrderByField.LASTNAME;
