package ru.gorbach.hw22.customer.repo.impl.memory;

import ru.gorbach.hw22.customer.domain.Customer;
import ru.gorbach.hw22.customer.search.CustomerOrderByField;

import java.util.*;

import static ru.gorbach.hw22.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static ru.gorbach.hw22.customer.search.CustomerOrderByField.FIRSTNAME;
import static ru.gorbach.hw22.customer.search.CustomerOrderByField.LASTNAME;
