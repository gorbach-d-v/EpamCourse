...
import ru.gorbach.hw22.storage.initor.exception.checked.ParseXmlException;

import java.util.ArrayList;
import java.util.List;

import static ru.gorbach.hw22.storage.initor.exception.InitDataExceptionMeta.PARSE_XML_EXCEPTION;
