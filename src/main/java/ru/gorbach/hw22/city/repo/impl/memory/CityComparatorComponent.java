package ru.gorbach.hw22.city.repo.impl.memory;

import ru.gorbach.hw22.city.domain.City;
import ru.gorbach.hw22.city.search.CityOrderByField;

import java.util.*;

import static ru.gorbach.hw22.city.search.CityOrderByField.NAME;
import static ru.gorbach.hw22.city.search.CityOrderByField.POPULATION;
