package ru.gorbach.hw16.city.repo.impl.memory;

import ru.gorbach.hw16.city.domain.City;
import ru.gorbach.hw16.city.search.CityOrderByField;

import java.util.*;

import static ru.gorbach.hw16.city.search.CityOrderByField.NAME;
import static ru.gorbach.hw16.city.search.CityOrderByField.POPULATION;
import static ru.gorbach.hw16.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
