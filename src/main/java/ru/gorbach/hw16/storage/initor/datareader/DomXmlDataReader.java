...
import ru.gorbach.hw16.country.domain.*;
import ru.gorbach.hw16.storage.initor.exception.checked.InitDataCheckedException;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static ru.gorbach.hw16.common.solutions.xml.dom.XmlDomUtils.*;
import static ru.gorbach.hw16.storage.initor.exception.InitDataExceptionMeta.PARSE_COUNTRY_DISCRIMINATOR_ERROR;
