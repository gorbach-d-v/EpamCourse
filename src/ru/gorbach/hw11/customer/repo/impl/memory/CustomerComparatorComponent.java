package ru.gorbach.hw11.customer.repo.impl.memory;

import ru.gorbach.hw11.customer.domain.Customer;
import ru.gorbach.hw11.customer.search.CustomerOrderByField;

import java.util.*;

import static ru.gorbach.hw11.common.business.repo.memory.CommonComparatorHolder.getComparatorForNullableStrings;
import static ru.gorbach.hw11.customer.search.CustomerOrderByField.FIRSTNAME;
import static ru.gorbach.hw11.customer.search.CustomerOrderByField.LASTNAME;
