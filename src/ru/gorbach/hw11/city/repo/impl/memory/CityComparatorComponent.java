package ru.gorbach.hw11.city.repo.impl.memory;

import ru.gorbach.hw11.city.domain.City;
import ru.gorbach.hw11.city.search.CityOrderByField;

import java.util.*;

import static ru.gorbach.hw11.city.search.CityOrderByField.NAME;
import static ru.gorbach.hw11.city.search.CityOrderByField.POPULATION;
